...
public partial class FunewsManagementContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            {
                // Fallback nếu không đọc được từ appsettings.json
                connectionString = "Server=localhost;Database=FUNewsManagement;User Id=sa;Password=12345;TrustServerCertificate=True;MultipleActiveResultSets=true;";
            }
